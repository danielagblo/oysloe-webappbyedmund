...
const SafetyTips: React.FC<{ textxs?: boolean }> = ({ textxs }) => (
  <div className="bg-white sm:bg-(--div-active) sm:p-6 rounded-2xl py-1 px-2 pb-5 lg:mx-6">
    <h2 className={`${textxs ? "text-base" : "text-xl"} font-bold mb-2 md:text-[1.75vw]`}>Safety tips</h2>
    ...
    <ol className={`list-disc ml-5 marker:text-black space-y-2 font-medium ${textxs? "text-[11px]" : "text-sm"} md:text-[1.125vw]`}>
