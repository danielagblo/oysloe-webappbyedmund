        ...
        <div className="flex flex-col items-center w-[calc(100%-0.2rem)] h-screen mt-[35px] px-20 gap-6 text-gray-600 ">
            ...
            <div className="w-full flex flex-col items-center gap-1">
                ...
                <div className="flex flex-row w-9/10 h-64 gap-1 bg-green-500">
                    ...
                    <div className="flex flex-row flex-wrap gap-1 h-[49.3%] w-8/10">
                        <img src="/3d-car-city-street.webp" alt="" className="object-cover  h-full w-full" />
                        <img src="/3d-car-city-street.webp" alt="" className="object-cover  h-full w-full" />
                    </div>
                    <div className="flex flex-row flex-wrap gap-1 h-[49.3%] w-8/10">
                    ...
                    <div className="bg-white p-6 rounded-lg">
                        ...
                        <div className="pt-4">
                            ...
                            <div className="flex gap-2">
                                <input type="text" placeholder="Start a chat" className="flex-1 border rounded-lg px-3 py-3 bg-[url('/send.svg')] bg-[length:20px_20px] bg-[center_right_12px] bg-no-repeat text-sm w-full" />
