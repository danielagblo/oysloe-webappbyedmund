...
const AdsDetailsPage = () => {
  ...
  const handleTouchEnd = (e: React.TouchEvent) => {
    ...
    const TitleAndPrice = () => (
        <div className="bg-white px-4 sm:px-12 py-2 w-full text-left sm:text-center rounded-lg">
    ...
    const SafetyTips = () => (
        <div className="bg-white sm:p-6 rounded-lg py-1 px-2 pb-5">
        <h2 className="text-xl font-bold mb-2">Safety tips</h2>
        <p className="text-gray-500 mb-3 py-1 px-2 rounded-2xl text-xs bg-[var(--div-active)]">Follow this tips and report any suspicious activity.</p>
    ...
    const ActionButtons = () => (
        <div>
            <div className="flex flex-wrap gap-2 mb-1">
                ...
                <button key={label} className="flex items-center gap-2 p-4 h-5 rounded-lg text-sm bg-[var(--div-active)] hover:bg-gray-50">
    ...
    const CommentsSection = () => (
        <div className="p-6 w-full sm:w-1/2 rounded-lg">
            <h2 className="text-2xl font-medium inline">Seller Reviews</h2>
    ...
    const QuickChat = () => (
        <div className="space-y-6 w-fit sm:w-1/2 ">
            ...
            <div className="inline-flex gap-2 mb-4 flex-wrap text-gray-400 font-extralight w-full">
                <button className="w-fit text-left p-2 bg-[var(--div-active)] rounded text-xs hover:bg-gray-100 inline">Is this Original?</button>
                <button className="w-fit text-left p-2 bg-[var(--div-active)] rounded text-xs hover:bg-gray-100 inline">Do you have delivery options?</button>
                <button className="w-fit text-left p-2 bg-[var(--div-active)] rounded text-xs hover:bg-gray-100 inline">What is the warranty period?</button>
                <button className="w-fit text-left p-2 bg-[var(--div-active)] rounded text-xs hover:bg-gray-100 inline">Can I see the service history?</button>
            </div>
            <div className="flex gap-2 w-full">
                <input
                    ...
                    className="rounded-2xl px-3 py-3 bg-[url('/send.svg')] bg-[length:20px_20px] bg-[center_right_12px] bg-no-repeat text-sm w-full"
                />
                <button style={{ border:"1px solid var(--div-border)" }} className="p-2 rounded-2xl hover:bg-gray-300">
    ...
    const SellerInfo = () => (
        <div>
            ...
            {/* profile bit */}
            <div className="flex flex-row gap-4 bg-[var(--div-active)] p-4 rounded-2xl mb-5">
