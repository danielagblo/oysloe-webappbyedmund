...
const ResetPasswordWithPhonePage = ({
  ...
  return (
    <div className="h-screen max-sm:bg-(--bg) text-(--dark-def) w-screen flex items-center justify-center">
      <div className="flex flex-col items-center justify-center w-11/12 sm:w-full m-8">
        <div className="flex flex-col gap-5 items-center max-sm:space-y-6 justify-center">
          <h2 className="text-2xl max-sm:text-[36px]">{page}</h2>
            ...
            {error &&
              (error.length < 20 ? (
                toast.error(error)
                  ...
                  toast.error("An error occurred. Please check your entered phone number and try again."),
