                ...
                <div className=" flex flex-col gap-5 items-center justify-center">
                    ...
                    <form className="relative">
                        <div className="flex flex-col gap-3">
                            ...
                            <input type="password" placeholder="Retype Password" className="border-gray-100 border-2 px-8 py-2 w-full bg-[8px_center] bg-[length:18px] bg-no-repeat bg-[url(Passwordkey.svg)] rounded-lg focus:border-gray-400 outline-0" />
                            <p className="text-[10px] pb-2">
                                ...
                                <label className="relative p-0 rounded-4xl cursor-pointer ml-2 -bottom-1 h-2 w-2 inline" htmlFor="custom-checkbox">
                                    ...
                                    <input type="checkbox"
                                        className="peer relative h-4 w-4 cursor-pointer appearance-none rounded-full border border-gray-400  checked:bg-[url(check.svg)] checked:bg-center checked:bg-no-repeat checked:bg-[length:18px_18px]" id="custom-checkbox" required />
                                </label>
                            </p>
                        </div>
