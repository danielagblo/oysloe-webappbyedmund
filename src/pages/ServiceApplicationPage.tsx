...
function ServiceApplicationPage() {
  ...
  const StepIndicator = () => (
    <div className="flex items-center max-sm:pb-5 gap-1 sm:gap-4 mb-2">
      {[1, 2, 3].map((step) => (
        <div key={step} className="flex items-center gap-1 sm:gap-2 flex-1 sm:flex-none">
          <div
          ...
          <span className={`hidden sm:inline text-xs sm:text-sm font-medium ${step === currentStep ? "text-(--dark-def)" : "text-gray-500"}`}>
            {step === 1 ? "Personal" : step === 2 ? "Additional" : "Review"}
          </span>
          {step < 3 && <div className="flex-1 sm:w-8 h-px bg-gray-300 mx-0.5 sm:mx-2" />}
        </div>
      ))}
    </div>
  );
      ...
      <div className="w-full lg:w-3/4 flex-1 lg:p-2 items-center justify-center flex px-3 sm:px-0">
        <div className="w-full lg:w-full flex flex-col rounded-none sm:rounded-2xl max-lg:min-h-screen sm:h-[93vh] sm:max-h-[93vh] bg-white sm:shadow-lg">
          <div className="flex items-center justify-between p-3 sm:p-4 border-b border-gray-200 gap-2">
            ...
            >
              <img src="/arrowleft.svg" alt="" className="h-4 w-4 sm:h-5 sm:w-5" />
            ...
            {profileLoading && currentStep === 1 ? (
              <div className="flex items-center justify-center py-8 sm:py-16">
                <div className="text-center">
                  ...
                  <p className="text-sm sm:text-base text-gray-600">Loading your profile...</p>
                </div>
              </div>
            ) : (
              <>
                ...
                {currentStep === 1 && (
                  <div className="w-full sm:max-w-2xl">
                    <div className="mb-4 sm:mb-6">
                      <h2 className="text-xl sm:text-3xl font-semibold mb-1 sm:mb-2">Personal details</h2>
                      <p className="text-gray-600 text-xs sm:text-base">Allow us to get to know you a bit by sharing some details about you.</p>
                    </div>
                ...
                {currentStep === 2 && (
                  <div className="w-full sm:max-w-2xl">
                    <div className="mb-4 sm:mb-6">
                      <h2 className="text-xl sm:text-3xl font-semibold mb-1 sm:mb-2">Additional details</h2>
                      <p className="text-gray-600 text-xs sm:text-base">In order to select you for the right job opportunities we need some more details.</p>
                    </div>
