...
function ServiceApplicationPage() {
  ...
  const handleSaveDraft = useCallback(async (isAutoSave: boolean = false) => {
    setIsSaving(true);
    try {
      ...
      localStorage.setItem("serviceApplicationDraft", JSON.stringify(dataToSave));
    ...
    <div className="flex items-center gap-4 mb-2">
      {[1, 2, 3].map((step) => (
        <div key={step} className="flex items-center gap-2">
          ...
          <span className={`text-sm font-medium ${step === currentStep ? "text-(--dark-def)" : "text-gray-500"}`}>
  ...
  return (
    <div className="flex w-screen min-h-screen bg-(--div-active) text-(--dark-def)">
      ...
      <div className="lg:w-3/4 flex-1 lg:p-2">
        <div className="lg:w-full flex flex-col rounded-2xl h-[93vh] bg-white shadow-lg">
          <div className="flex items-center justify-between p-4 sm:p-2 border-b border-gray-200">
            <button
              onClick={handleBack}
              disabled={currentStep === 1}
              className="flex items-center gap-2 text-sm sm:text-base font-medium text-(--dark-def) disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-80"
            >
            ...
            <button
              ...
              disabled={isSaving}
              className={`px-6 py-2 bg-(--dark-def) text-white rounded-lg text-sm sm:text-base font-medium transition-all ${
          ...
          {/* Form */}
          <div className="flex-1 px-4 sm:px-6 pb-8 overflow-y-auto no-scrollbar">
            ...
            {currentStep === 1 && (
              <div className="max-w-2xl">
                <div className="mb-6">
                  <h2 className="text-2xl sm:text-3xl font-semibold mb-2">Personal details</h2>
                  <p className="text-gray-600 text-sm sm:text-base">Allow us to get to know you a bit by sharing some details about you.</p>
                </div>
            ...
            {currentStep === 2 && (
              <div className="max-w-2xl">
                <div className="mb-6">
                  <h2 className="text-2xl sm:text-3xl font-semibold mb-2">Additional details</h2>
                  <p className="text-gray-600 text-sm sm:text-base">In order to select you for the right job opportunities we need some more details.</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                      ...
                      <div className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <span className="text-2xl">
                            <img src="/resume.svg" className="h-6 w-6" alt="resume" />
                          </span>
                          <div>
                        ...
                        >
                          <img src="/bin-svg.svg" className="h-6 w-6" alt="delete" />
                        </button>
                      </div>
                    ) : null}
                    ...
                    <p className="text-xs text-gray-500 mt-2">Max file size 10MB (pdf, doc, docx)</p>
                  </div>
                </div>
            ...
            {currentStep === 3 && (
              <div className="max-w-2xl">
                <div className="mb-6 flex items-center justify-between">
                  <h2 className="text-2xl sm:text-3xl font-semibold">Review your application</h2>
                  <button
                ...
                <p className="text-gray-600 text-sm sm:text-base mb-8">Is your information correct?</p>
                  ...
                  <div>
                    ...
                    {formData.resume ? (
                      <div className="flex items-center gap-2 p-3 bg-white border border-gray-200 rounded-lg w-fit">
                        ...
                        <span className="text-xs text-gray-500">({(formData.resume.size / 1024 / 1024).toFixed(2)} MB)</span>
                      </div>
                    ) : (
                      <div className="flex items-center flex-col justify-center">
                        <img src="/nothing-to-show.png" className="h-15 w-15" alt="nothing to show" />
