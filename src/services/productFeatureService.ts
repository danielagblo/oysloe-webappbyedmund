...
export const getProductFeatures = async (params?: {
  ...
  return apiClient.get<ProductFeature[]>(
    `${endpoints.products.features.list}${query}`,
  );
};
...
export const createProductFeature = async (
  ...
  return apiClient.post<ProductFeature>(
    endpoints.products.features.create,
    body,
  );
};

export const updateProductFeature = async (args: {
  id: number;
  body: ProductFeaturePayload;
}): Promise<ProductFeature> => {
...
export const patchProductFeature = async (args: {
  id: number;
...
export const deleteProductFeature = async (args: {
  id: number;
}): Promise<void> => {
