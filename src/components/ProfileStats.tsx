  ...
  const Profile = () => (
    <div className="flex flex-col items-center pb-6 border-b border-gray-100 ">
      ...
      <div className="flex flex-col justify-start">
        <div>
          <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline">
            <ellipse cx="5" cy="5.24271" rx="5" ry="4.96781" fill="#74FFA7"/>
            <path d="M2.05218 4.39318C2.37825 4.18062 2.83842 4.2557 3.08 4.56089L4.8702 6.82242L3.6894 7.59217L1.89921 5.33064C1.65763 5.02545 1.72611 4.60574 2.05218 4.39318Z" fill="#374957"/>
            <rect width="6.34413" height="1.26744" rx="0.633722" transform="matrix(-0.830425 0.55713 -0.631604 -0.775291 9.14648 4.37305)" fill="#374957"/>
          </svg>
