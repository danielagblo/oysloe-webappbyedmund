...
export default function PostAdForm() {
  ...
  //     <div className="text-xs flex flex-col lg:flex-row w-full h-full overflow-y-auto flex-1 min-h-0 gap-6 lg:gap-2 py-3 pr-2 lg:overflow-y-hidden">
  //       <div className="flex flex-col w-full lg:w-3/5 shadow-lg bg-white rounded-xl p-4 sm:p-6 space-y-4 overflow-y-scroll no-scrollbar">
  ...
  //       <div className="relative flex flex-col w-full lg:w-2/5 bg-white shadow-lg rounded-xl p-4 sm:p-6 mt-4 lg:mt-0">
  ...
  //         <div ref={gridRef} className="grid grid-cols-3 sm:grid-cols-4 gap-3 sm:gap-4 relative mt-3">
        ...
        {(!isMobile || mobileStep === "form") && (
          <div className="flex flex-col w-full lg:w-3/5 lg:shadow-lg bg-white lg:rounded-xl p-4 sm:p-6 space-y-4 flex-1 min-h-0 overflow-y-auto no-scrollbar">
            ...
            <div>
              ...
              <p className="text-[8px] text-[var(--bg-active)] mt-1 font-bold">
                <svg className="inline" width="9" height="9" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <mask id="mask0_18425_111" maskUnits="userSpaceOnUse" x="0" y="0" width="12" height="12">
                    <path d="M12 0H0V12H12V0Z" fill="white"/>
                  </mask>
                  <g mask="url(#mask0_18425_111)">
            ...
            {isMobile && (
              <div className="w-full flex justify-center items-center">
                <button
                  ...
                  type="button"
                  className="fixed bottom-20 sm:bottom-25 w-4/5 py-4 sm:py-7 bg-[var(--dark-def)] text-white rounded-xl hover:bg-[var(--accent)] hover:text-[var(--dark-def)] border hover:border-[var(--dark-def)] transition"
                >
                  Next →
                </button>
              </div>
