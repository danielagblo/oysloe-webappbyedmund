  ...
  if (page !== "default") {
    return (
      <button
        ...
        className="px-8 py-3 w-full bg-[#F9F9F9] text-(--dark-def) max-sm:bg-white max-sm:h-[50px] max-sm:w-[152px] rounded-full text-[12px] sm:text-xs hover:bg-gray-100 transition cursor-pointer"
      >
        Login
      </button>
    )
