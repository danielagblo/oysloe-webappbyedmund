...
const ReportModal: React.FC<Props> = ({ isOpen, message, setMessage, onClose, onSubmit }) => {
            ...
            >
                <div className="flex items-start gap-3">
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mb-3">Describe the issue so our team can review it.</p>
                    </div>
                    <button aria-label="Close report modal" onClick={onClose} className="text-gray-500 hover:text-gray-700">✕</button>
                </div>
                ...
                <div className="flex justify-end gap-3">
                    <button onClick={onClose} className="px-4 py-2 bg-gray-100 rounded text-sm hover:scale-95 transition">Cancel</button>
                    <button
                        onClick={async () => {
                            await onSubmit();
                        }}
